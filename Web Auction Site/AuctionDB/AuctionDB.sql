...
-- Κυρ 18 Σεπ 2016 11:45:45 μμ EEST
...
CREATE TABLE IF NOT EXISTS `mydb`.`Auction` (
  ...
  `Buyout_user` VARCHAR(45) NULL DEFAULT NULL,
  `Creator` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`AuctionId`),
  INDEX `fk_Auction_User1_idx` (`Buyout_user` ASC),
  INDEX `Creator` (`Creator` ASC),
  CONSTRAINT `fk_Auction_User1`
    FOREIGN KEY (`Buyout_user`)
    REFERENCES `mydb`.`User` (`UserId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Auction_User2`
    FOREIGN KEY (`Creator`)
    REFERENCES `mydb`.`User` (`UserId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `mydb`.`User_bid_Auction` (
  ...
  PRIMARY KEY (`User_UserId`, `Auction_AuctionId`, `Price`),
